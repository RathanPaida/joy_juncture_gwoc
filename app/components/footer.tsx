      ...
      <div className="footer-content">
        ...
        <div className="footer-links">
          <div className="link-group">
            ...
            <ul>
              ...
              <li><Link href="/games/board">Board Games</Link></li>
              <li><Link href="/games/card">Card Games</Link></li>
              <li><Link href="/games/new">New Releases</Link></li>
              <li><Link href="/archives">Game Archives</Link></li>
            </ul>
          </div>
          ...
          <div className="link-group">
            ...
            <ul>
              ...
              <li><Link href="/vault">Token Vault</Link></li>
              <li><Link href="/rewards">System Rewards</Link></li>
            </ul>
          </div>
          ...
          <div className="link-group">
            <h3>SUPPORT</h3>
            <ul>
              <li><Link href="/faq">Game Guides & FAQ</Link></li>
        ...
        <div className="footer-legal">
          <div className="community-updates">
            <h3>🔥 LIVE NOW</h3>
            <p className="live-stats">1,240 PLAYERS ONLINE • LEADERBOARD RESET IN 2 DAYS</p>
          </div>
          ...
          <div className="legal-links">
            ...
            <span className="copyright">© {new Date().getFullYear()} JoyJuncture. Forge your legacy.</span>
          </div>
        </div>
