    ...
    <div className="bg-gradient-to-br from-orange-500/10 via-orange-500/5 to-blue-500/10 rounded-2xl p-6 border border-orange-500/30">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-semibold text-white">
          Game Guides Newsletter
        </h3>
      </div>

      <p className="text-gray-300 text-sm mb-4">
        Get weekly gameplay guides, strategy tips, and community stories
      ...
      <p className="mt-4 text-xs text-gray-500">
        By subscribing, you agree to our Privacy Policy and may receive Game
        Points rewards!
      </p>
    </div>
  );
