...
const Navbar: React.FC = () => {
        ...
        <div className={`nav-items ${isMenuOpen ? 'active' : ''}`}>
          {navItems.map((item) => (
            <div 
              ...
              onMouseEnter={() => window.innerWidth > 768 && item.dropdown && setActiveDropdown(item.id)}
              onMouseLeave={() => window.innerWidth > 768 && item.dropdown && setActiveDropdown(null)}
            >
              <Link 
                href={item.href} 
              ...
              >
                ...
                {item.label}
                {item.dropdown && <FaChevronDown className="dropdown-chevron" />}
              </Link>
  ...
  >
    ...
    <span className="admin-text">Admin</span>
          ...
          {user && (
            <div className="wallet-balance" onClick={() => router.push('/walletandpoints')}>
              <FaWallet />
              <span className="wallet-amount">{userPoints.toLocaleString()} pts</span>
            </div>
          )}
          ...
          {user ? (
            <div className="user-profile" onMouseEnter={() => window.innerWidth > 768 && setIsProfileOpen(true)}>
              <button 
              ...
              >
                ...
                <FaChevronDown className={`profile-chevron ${isProfileOpen ? 'active' : ''}`} />
              </button>
              ...
              {isProfileOpen && (
                <div 
                  ...
                  onMouseLeave={() => window.innerWidth > 768 && setIsProfileOpen(false)}
                >
