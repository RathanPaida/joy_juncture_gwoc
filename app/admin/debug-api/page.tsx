        ...
        try {
          ...
          if (contentType?.includes("application/json")) {
            try {
              ...
              testResults[api.name].dataPreview = JSON.stringify(
                data,
              ).substring(0, 100);
            } catch (jsonError) {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        {results.globalError && (
          <div style={styles.error}>❌ Global Error: {results.globalError}</div>
        )}
              ...
              >
                ...
                <div style={styles.details}>
                  ...
                  {result.isHTML && (
                    <div style={styles.error}>
                      <strong>
                        ⚠️ PROBLEM: API is returning HTML instead of JSON!
                      </strong>
                      <br />
                      <br />
                      This means the API route file doesn't exist or has an
                      error.
                      <br />
                  ...
                  {result.jsonError && (
                    <div style={styles.warning}>
                      ⚠️ Response is JSON but failed to parse:{" "}
                      {result.jsonError}
                    </div>
                  )}
                </div>
          ...
          <div style={{ marginTop: "2rem" }}>
            ...
            <div style={styles.summary}>
              {Object.entries(results)
                .filter(([k]) => k !== "error" && k !== "globalError")
