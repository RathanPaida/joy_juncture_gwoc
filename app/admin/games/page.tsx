...
export default function AdminGamesPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(
          data.error || `Failed to ${editingGame ? "update" : "add"} game`,
        );
      }
    } catch (err: any) {
      console.error(err);
  ...
  const addFeature = () =>
    setGameForm((prev) => ({ ...prev, features: [...prev.features, ""] }));
        ...
        {isLoading ? (
          ...
          <div style={{ textAlign: "center", padding: "4rem" }}>
            ...
            <p style={{ color: colors.textLight }}>
              Click "Add New Game" to create your first card game
            </p>
          </div>
        ) : (
          <div
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Dead Man's Deck"
                  style={{
                    width: "100%",
                    padding: "12px",
                    background: colors.light,
              ...
              >
                <div>
                  ...
                  <input
                    type="text"
                    value={gameForm.regularPrice}
                    onChange={(e) =>
                      setGameForm({ ...gameForm, regularPrice: e.target.value })
                    }
                    placeholder="Rs. 799.00"
                    style={{
                      width: "100%",
                      padding: "12px",
                      background: colors.light,
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={gameForm.salePrice}
                    onChange={(e) =>
                      setGameForm({ ...gameForm, salePrice: e.target.value })
                    }
                    placeholder="Rs. 599.00"
                    style={{
                      width: "100%",
                      padding: "12px",
                      background: colors.light,
                ...
                >
                  {categories.map((cat) => (
                    <button
                      ...
                      style={{
                        background: gameForm.category.includes(cat.id)
                          ? colors.primary
                          : colors.light,
                        color: gameForm.category.includes(cat.id)
                          ? colors.dark
                          : colors.text,
                        border: `1px solid ${gameForm.category.includes(cat.id) ? colors.primary : colors.border}`,
                        borderRadius: "6px",
                        padding: "8px 12px",
                        cursor: "pointer",
                        fontSize: "0.85rem",
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setGameForm({ ...gameForm, duration: e.target.value })
                    }
