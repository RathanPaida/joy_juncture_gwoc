    ...
    try {
      ...
      if (data.success) {
        ...
        if (data.product.images && data.product.images.length > 0) {
          ...
          setMediaUrls([{ url: data.product.media.thumbnail, isPrimary: true }]);
        }
      } else {
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    updateNestedField('price', 'amount', isNaN(value) ? 0 : value);
                  }}
                  className="w-full px-4 py-3 bg-gray-900/50 border-2 border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:border-transparent transition-all"
                  placeholder="999"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const value = e.target.value === '' ? 0 : parseInt(e.target.value);
                    updateNestedField('stock', 'quantity', isNaN(value) ? 0 : value);
                  }}
                  className="w-full px-4 py-3 bg-gray-900/50 border-2 border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:border-transparent transition-all"
                  placeholder="50"
                />
