...
export default function CardGamesPage() {
  ...
  const getFallbackGames = (): CardGame[] => {
    return [
      ...
      },
      {
        ...
        description:
          "Musical card game that combines music knowledge with fun challenges. Great for celebrations and parties.",
        regularPrice: "₹799",
        salePrice: "₹499",
      ...
      },
      {
        ...
        description:
          "Bollywood themed bidding game with movie trivia and auctions. Perfect for Indian weddings and celebrations.",
        regularPrice: "₹799",
        salePrice: "₹499",
        category: ["birthday-anniversary", "wedding", "carnival-games"],
        players: "3-8 Players",
      ...
      },
      {
        ...
        description:
          "Complete murder mystery game with case files and investigation. Professional setup for immersive experiences.",
        regularPrice: "₹1,999",
        salePrice: "₹999",
        category: ["corporate-engagement", "carnival-games"],
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1511578314322-379afb476865?w=400&h=225&fit=crop",
      },
      {
        id: "5",
        name: "Buzzed – The Drinking Card Game",
        description:
          "Fun party drinking game for adult gatherings and birthday celebrations.",
        regularPrice: "₹599",
        salePrice: "₹359",
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=400&h=225&fit=crop",
      },
      {
        id: "6",
        name: "Judge Me & Guess",
        description:
          "Judgment and guessing game that reveals interesting facts about players.",
        regularPrice: "₹1,499",
        salePrice: "₹999",
      ...
      },
      {
        ...
        description:
          "Jigsaw puzzle game with drinking challenges for fun gatherings.",
        regularPrice: "₹599",
        salePrice: "₹399",
        category: ["birthday-anniversary", "carnival-games"],
        players: "2-6 Players",
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1492684223066-dd23140edf6d?w=400&h=225&fit=crop",
      },
    ];
  };
    ...
    return [
      {
        ...
        includes: {
          food: [
            ...
            "Customized celebration menu",
          ],
          planning: [
            "Theme decoration",
            "Game station setup",
            "Prize distribution",
            "Celebration timeline management",
          ],
          sound: [
      ...
      },
      {
        ...
        includes: {
          food: [
            "Grand buffet setup",
            "Live food counters",
            "Wedding cake station",
            "Traditional sweets & desserts",
          ],
          planning: [
            "Complete wedding game setup",
            "Multiple entertainment zones",
            "Bride-groom game coordination",
      ...
      },
      {
        ...
        includes: {
          ...
          sound: [
            ...
            "Presentation audio setup",
            "Team announcements",
            "Professional AV system",
          ],
          photography: [
            "Team activity photos",
      ...
      },
      {
        ...
        includes: {
          ...
          planning: [
            "Multiple game zones setup",
            "Prize redemption counter",
            "Queue management",
            "Safety & crowd control",
          ],
          sound: [
            "Carnival atmosphere music",
            "Game announcement system",
            "Zone-specific audio",
            "Entertainment DJ",
          ],
          photography: [
            "Carnival action shots",
            "Prize winner photos",
            "Crowd moments",
            "Event documentation",
          ],
          games: [
            "All featured card games",
            "Carnival classic games",
            "Prize challenge games",
  ...
  const filteredPackages = gamePackages.filter(
  ...
  const calculateTotalPrice = () => {
    const selectedPackage = gamePackages.find(
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ color: colors.textLight }}>
            Please wait while we fetch the latest offerings
          </p>
          <style jsx>{`
            @keyframes spin {
              0% {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Thank you for your booking! We'll contact you within 24 hours to
            confirm details.
          </p>
          <button
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          >
            Professional card game setups for all celebrations with complete
            event planning
          </p>
              ...
              style={{
                ...
                background:
                  selectedCategory === category.id
                    ...
                    : colors.background,
                color:
                  selectedCategory === category.id ? colors.dark : colors.text,
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          {filteredGames.length === 0 ? (
            ...
            >
              ...
              <p>
                Try selecting a different category above or check back later for
                new games
              </p>
            </div>
          ) : (
                      ...
                      <>
                        {pkg.includes.food && pkg.includes.food.length > 0 && (
                          <div style={{ marginBottom: "1.5rem" }}>
                            ...
                            >
                              <span style={{ color: pkgColor }}>🍽️</span> Food &
                              Beverages
                            </h4>
                            <ul
                              style={{
                        ...
                        {pkg.includes.planning &&
                          pkg.includes.planning.length > 0 && (
                            <div style={{ marginBottom: "1.5rem" }}>
                              <h4
                                style={{
                                  color: colors.text,
                              ...
                              >
                                <span style={{ color: pkgColor }}>📋</span>{" "}
                                Event Planning
                              </h4>
                              <ul
                                style={{
                        ...
                        {pkg.includes.photography &&
                          pkg.includes.photography.length > 0 && (
                            <div style={{ marginBottom: "1.5rem" }}>
                              <h4
                                style={{
                                  color: colors.text,
      ...
      >
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          >
            Fill out the form below to book your premium card games event. We'll
              ...
              onMouseEnter={(e) => {
                if (!submitLoading) {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 10px 25px rgba(230, 126, 34, 0.3)";
                }
              }}
              onMouseLeave={(e) => {
                if (!submitLoading) {
