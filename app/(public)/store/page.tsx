  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-gray-800">
      ...
      <section className="bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 text-white py-16 relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-32 h-32 bg-orange-400/20 rounded-full -translate-x-16 -translate-y-16"></div>
        <div className="absolute bottom-0 right-0 w-48 h-48 bg-amber-600/10 rounded-full translate-x-24 translate-y-24"></div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        {items.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white/5 rounded-2xl backdrop-blur-sm border border-orange-500/20">
