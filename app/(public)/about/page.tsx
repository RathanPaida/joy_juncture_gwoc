    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/60 max-w-2xl mx-auto mb-12 leading-relaxed">
            We craft experiences that transform ordinary moments into
            extraordinary connections through the magic of play.
          </p>
          ...
          >
            <a
              href="#story"
              className="group px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl font-bold text-black hover:shadow-[0_0_40px_rgba(251,146,60,0.4)] transition-all duration-300"
            ...
            <a
              href="#values"
              className="px-8 py-4 border border-white/20 rounded-2xl font-medium hover:bg-white/5 hover:border-white/40 transition-all duration-300"
          ...
          >
            <div className="lg:w-1/3 lg:sticky lg:top-32">
              ...
              <p className="text-white/50 mt-6 text-lg leading-relaxed">
                We believe play is not just entertainment—it's a fundamental
                human need that connects us, heals us, and brings out the best
                in us.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Around a game table, strangers become friends and friends become family. Every roll of the dice, every card played, is a shared moment that weaves people together.",
                ...
                },
                {
                  ...
                  description:
                    "The most innovative companies and happiest families share one secret: they play together. Play builds trust, sparks creativity, and solves problems no meeting ever could.",
                ...
                },
                {
                  ...
                  description:
                    "You're not a customer to us—you're a player in our growing world. Every game night, every laugh shared, adds another thread to the tapestry of our community.",
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${card.gradient} rounded-3xl opacity-0 group-hover:opacity-10 blur-xl transition-all duration-500`}
                  />
                  <div className="relative p-8 md:p-10 rounded-3xl border border-white/10 bg-white/[0.02] hover:border-white/20 transition-all duration-300">
                    <div
                      className={`inline-flex p-3 rounded-2xl bg-gradient-to-br ${card.gradient} mb-6`}
                    >
            ...
            {[
              {
                year: "2018",
                title: "The Spark",
                desc: "A difficult season led to a game night that changed everything. We saw how play could heal, connect, and transform.",
              },
              {
                year: "2019",
                title: "Dead Man's Deck",
                desc: "Our first game went from napkin sketch to party sensation. Friends demanded copies. Something was brewing.",
              },
              {
                year: "2020",
                title: "The Digital Pivot",
                desc: "When the world went remote, we brought game nights online. Distance couldn't stop the joy.",
              },
              {
                year: "2022",
                title: "Joy Juncture Is Born",
                desc: "With 5 games and a dream, we officially launched. The mission: make every gathering more joyful.",
              },
              {
                year: "Now",
                title: "Building the Future",
                desc: "15+ games. 200+ events. Thousands of players. And we're just getting started.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                <div
                  className={`flex-1 pl-20 md:pl-0 ${i % 2 === 0 ? "md:pr-16 md:text-right" : "md:pl-16"}`}
                >
                  <div
                    className={`inline-block px-4 py-1 rounded-full text-sm font-bold bg-orange-500/20 text-orange-400 border border-orange-500/30 mb-3`}
                  >
                    {item.year}
                  </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="absolute -top-8 -left-8 text-[200px] font-serif text-orange-500/10 leading-none select-none">
              "
            </div>
            <div className="relative p-12 md:p-16 rounded-[40px] border border-white/10 bg-gradient-to-br from-white/[0.05] to-transparent backdrop-blur-sm">
              <blockquote className="text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed text-white/90 mb-10">
                Games aren't just about winning or losing. They're about the
                laughter in between, the stories created, and the connections
                forged. We're not making games—we're crafting memories.
              </blockquote>
            ...
            {[
              {
                icon: FaLightbulb,
                title: "Creativity",
                desc: "We approach everything with wonder and imagination. Every game is a canvas for new ideas.",
                color: "text-yellow-400",
              },
              {
                icon: FaUsers,
                title: "Inclusivity",
                desc: "Everyone belongs at our table. No skill level required—just a willingness to play.",
                color: "text-blue-400",
              },
              {
                icon: FaHeart,
                title: "Authenticity",
                desc: "We keep it real. Our games, our team, our community—all genuine, all heart.",
                color: "text-rose-400",
              },
              {
                icon: FaAward,
                title: "Excellence",
                desc: "Every detail matters. From card stock to rule clarity, we obsess over quality.",
