  ...
  try {
    ...
    const formattedGames = games.map(game => ({
      ...
      features: Array.isArray(game.features) 
        ...
        : [],
      imageUrl: game.imageUrl || game.image || 'https://images.unsplash.com/photo-1546484475-7f7bd55792da?w=400&h=225&fit=crop',
    ...
    const fallbackGames = [
      ...
      },
      {
        ...
        description: "An elegant card game perfect for weddings and formal events with a touch of sophistication.",
        regularPrice: "₹1,299",
        salePrice: "₹999",
        category: ["wedding"],
        players: "2-6 Players",
      ...
      },
      {
        id: "3",
        name: "Carnival Cards",
        description: "Fun and fast-paced card games perfect for carnivals and family events.",
        regularPrice: "₹899",
        salePrice: "₹699",
