...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to fetch discussions', details: error.message },
      { status: 500 }
    );
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to create discussion', details: error.message },
      { status: 500 }
    );
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to update discussion', details: error.message },
      { status: 500 }
    );
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { success: false, error: 'Failed to delete discussion', details: error.message },
      { status: 500 }
    );
  }
}