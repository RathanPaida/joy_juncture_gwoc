...
const products = [
  {
    ...
    faqs: [
      {
        ...
        answer: "Absolutely! Throw in the Challenge Cards, grab your drink of choice, and prepare for a night of zombie-fueled fun. But you can also play it totally sober—your call!"
      },
      {
      ...
      },
      {
        ...
        answer: "The game is perfect for 2-8 players. Whether it's you and your buddy or a whole crew, there's plenty of undead drama for everyone!"
      }
    ],
    ...
    media: {
      thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1/joy-juncture/dead-mans-deck/thumbnail.jpg",
      images: [
  ...
  
  {
    ...
    faqs: [
      {
        ...
        answer: "Not at all! Mehfil is about fun, not perfection. Whether you can sing like a pro or just hum along, everyone has a blast!"
      },
      {
        question: "How many people can play?",
        answer: "From 1 to 99+! It's perfect for any group size—intimate gatherings or massive parties."
      }
    ],
    ...
    media: {
      thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1767795261/mehfil_yadwyq.png",
      images: [
  ...
  
  {
    ...
    faqs: [
      {
        ...
        answer: "Not necessarily! While Bollywood fans will love it, even casual viewers can enjoy the fun challenges and learn along the way."
      },
      {
        question: "Is it suitable for family gatherings?",
        answer: "Absolutely! Tamasha is perfect for family game nights, Diwali celebrations, and any Bollywood-loving crowd."
      }
    ],
    ...
    media: {
      thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1767795594/IMG_2447_nxujxs.png",
      images: [
  ...
  faqs: [
    {
      ...
      answer: "While it's designed as a drinking game, you can totally play it with non-alcoholic drinks or even skip drinking entirely. The prompts are hilarious on their own!"
    },
    {
      question: "How many people can play?",
      answer: "Buzzed works for 2 to 99+ players! Whether it's a small hangout or a massive party, everyone gets in on the fun."
    },
    {
      question: "Is it suitable for all parties?",
      answer: "Buzzed is designed for adults 18+ with mature humor. Perfect for house parties, college hangouts, bachelor/bachelorette parties, and adult game nights."
    },
    {
      question: "How long does a game last?",
      answer: "As long as you want! Games typically run 30-90 minutes, but you can keep going as long as the party's alive."
    },
    {
      question: "Can we play with mocktails?",
      answer: "Absolutely! Swap in mocktails, juices, or even water. The fun comes from the prompts and the company, not necessarily the alcohol."
    }
  ],
  ...
  media: {
    thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1767795360/buzz1_svuvso.jpg",
    images: [
...
},
{
  ...
  faqs: [
    {
      ...
      answer: "Most teams take 60-120 minutes depending on their detective skills. Some finish faster, while others take their time savoring every clue!"
    },
    {
      question: "Can I play solo?",
      answer: "Yes! While designed for 3-5 players, you can definitely play solo. However, discussing theories with teammates makes it more fun and immersive."
    },
    {
      question: "Is it replayable?",
      answer: "Once you solve it, you know the answer. However, it's great to play with different friend groups! Each team approaches the mystery differently."
    },
    {
      question: "How difficult is it?",
      answer: "It's rated 'Hard' difficulty. You'll need to pay attention to details, connect subtle clues, and think critically. Perfect for mystery lovers who want a challenge!"
    },
    {
      question: "Do I need any additional materials?",
      answer: "Nope! Everything you need is in the case file. Just grab a pen/paper for notes and you're ready to start investigating."
    },
    {
      question: "Is it suitable for team building?",
      answer: "Absolutely! The Bloody Inheritance is perfect for corporate team-building. It promotes collaboration, communication, and critical thinking in a fun, engaging way."
    }
  ],
  ...
  media: {
    thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1767794693/bloody_pfuiii.png",
    images: [
...
,
{
  ...
  faqs: [
    {
      ...
      answer: "The game starts with light, warm-up questions (Level 1), progresses to moderate personal questions (Level 2), and culminates in bold, deeper questions (Level 3). You control the pace!"
    },
    {
      question: "Can I play this with strangers?",
      answer: "Absolutely! Judge Me & Guess is designed to turn strangers into friends. Start with Level 1 questions to break the ice, then progress naturally."
    },
    {
      question: "Is it only for couples or dates?",
      answer: "Not at all! While great for dates, it works perfectly for friend groups, office teams, family dinners, café meetups, and any social gathering."
    },
    {
      question: "How many people can play?",
      answer: "Ideal for 2-8+ players. Works best in intimate groups where everyone can participate in the guessing and judging."
    },
    {
      question: "Do I need to follow specific rules?",
      answer: "Nope! Judge Me & Guess has no fixed rules. Play it your way - add points, create punishments, or just enjoy the conversations. It adapts to your vibe."
    },
    {
      question: "Can I use it in public spaces like cafés?",
      answer: "Yes! The game includes a stylish display stand perfect for café tables. It's designed to be community-friendly and adds to the ambiance."
    }
  ],
  ...
  media: {
    thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1767794808/judge_kmoq4n.png",
    images: [
...
,{
  ...
  faqs: [
    {
      ...
      answer: "Most people complete it in 2-4 hours, depending on puzzle experience. It's the perfect length for a relaxed evening or a fun weekend activity!"
    },
    {
      question: "Is 150 pieces too easy for adults?",
      answer: "Not at all! The hand-illustrated details and vibrant colors create a satisfying challenge. It's engaging without being frustrating - perfect for casual puzzling."
    },
    {
      question: "Can I frame it after completion?",
      answer: "Absolutely! The 30 x 21 cm size fits standard frames perfectly. Many customers frame it as fun wall art for game rooms or living spaces."
    },
    {
      question: "Is it made with eco-friendly materials?",
      answer: "Yes! One More Round uses eco-friendly ink and recycled board. Quality puzzling with a conscience!"
    },
    {
      question: "What are the hidden surprises?",
      answer: "The artwork is packed with fun details - from spilled drinks to cheeky expressions. There's even an odd drink hidden in the scene. Can you spot it?"
    },
    {
      question: "Is it suitable as a gift?",
      answer: "Perfect gift for puzzle lovers, game night enthusiasts, or anyone who appreciates unique, fun artwork. Great for birthdays, housewarming, or just because!"
    }
  ],
  ...
  media: {
    thumbnail: "https://res.cloudinary.com/dwvb2cgmq/image/upload/w_800,h_600,c_fill,f_auto,q_auto/v1767795889/onemore3_tvdwfj.png",
    images: [
